    ...
    .directive('revSlider', ['$timeout', function ($timeout) {
        return {
            ...
            templateUrl: function(element, attrs) {
                return attrs.sliderTemplateUrl || '../../partials/slidertemplate.html';
            },
...
angular.module("rev.slider.tpls", ["../../partials/slidertemplate.html"]);
angular.module("../../partials/slidertemplate.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put('../../partials/slidertemplate.html',
