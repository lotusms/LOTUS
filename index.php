...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- Meta-Information -->
        <title>LOTUS Marketing Solutions LLC</title>
        <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="We are a web design & web marketing company in Harrisburg, PA. We offer very affordable prices and comfortable payment plans for less than a $1 a day.">
        ...
        <link href="revolution/css/captions-original.min.css" rel="stylesheet"/>
        <link href="revolution/css/settings.min.css" rel="stylesheet"/>
    ...
    <body ng-app="angula">
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBk6kocSpaMaa8aeQP1NUv7S3VwuASZ2Mw"></script>
        ...
        <script src="revolution/js/extensions/revolution.extension.video.min copy.js"></script>
